    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Actualizar Vendedor</h5>
                ...
                <div>
                    <form id="idFormEditar" autocomplete="off">
                        <div id="conteiner" class="container">
                            ...
                            <div class="row">
                                <input id="idVendedorEditar" name="vendedorEditar" type="text" style="width: 5px"
                                       class="invisible"/>
                            </div>
                        </div>
                    </form>
            ...
            <div class="modal-footer">
                <input type="button" class="btn btn-warning" onclick="confirmarVendedorActualizacion()"
                       value="Actualizar">
            </div>
        </div>
    </div>
