...
<body>
<div class="modal fade " id="modalRegistroVenNuevo" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    <form id="idFormRegistroVen" autocomplete="off">
            ...
            <div class="modal-footer">
                <input type="button" class="btn btn-primary" onclick="agregarVendedor()"
                       value="Guardar">
            </div>
        </div>
    </div>
