    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown" id="menuVentas">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <li><a class="dropdown-item" href="vVentasMostrador.php">Mostrador</a></li>
                    <li><a class="dropdown-item" href="vVentasAbonos.php">Abono</a></li>
                    <li><a class="dropdown-item" href="vVentasApartados.php">Apartados</a></li>
                </ul>
            </li>
