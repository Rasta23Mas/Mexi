    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown" id="menuVentas">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <li><a class="dropdown-item" href="../Empeno/pruebas.php">Mostrador (P)</a></li>
                    <li><a class="dropdown-item" href="../Empeno/pruebas.php">Abono (P)</a></li>
                    <li><a class="dropdown-item" href="../Empeno/pruebas.php">Apartados (P)</a></li>
                    <li><a class="dropdown-item" href="../Empeno/pruebas.php">Reportes (P)</a></li>
                </ul>
            </li>
            <li class="nav-item dropdown" id="menuInventario">
                <a class="nav-link" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
                   aria-expanded="false">
                    Inventario
                </a>
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <li><a class="dropdown-item" href="../Empeno/pruebas.php">Existencias (P)</a></li>
                    <li><a class="dropdown-item" href="../Empeno/pruebas.php">Inventario F&iacute;sico (M)</a></li>
                </ul>
            </li>
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <li><a class="dropdown-item dropdown-toggle" href="#">Empeños</a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="../Empeno/pruebas.php">Contratos Almoneda (M)</a></li>
                    ...
                    <li><a class="dropdown-item dropdown-toggle" href="#">Monitoreo (P)</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="../Empeno/pruebas.php">Re-Impresiones(P)</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
