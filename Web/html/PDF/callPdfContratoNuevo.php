            ...
            <table  align="center" border="1">
                <tbody >
                   ...
                   <tr class="tituloCelda">
                        <td colspan="2"  class="tableFormat"><label class="letraCelda">Cat<br> Costo Anual Total </label></td>
                        <td colspan="2"  class="tableFormat"><label class="letraCelda">TASA DE <br>INTERÉS <br>ANUAL </label></td>
                        <td colspan="2"  class="tableFormat"><label class="letraCelda">MONTO DEL<br> PRÉSTAMO<br> (MUTUO) </label></td>
                        <td colspan="2"  class="tableFormat"><label class="letraCelda">MONTO TOTAL A<br> PAGAR </label></td>
                        <td colspan="4" class="tableFormat"><label class="letraCelda">COMISIONES<br> Montos y cláusulas  </label></td>
                    </tr>
                    <tr >
                        ...
                        <td colspan="4" class="tableFormat" style="text-align: left">
                            ...
                            Gastos de Administración <u>$ 0.00</u> (Claus 11f)<br> </label>
                        </td>
                    </tr>
                    <tr class="tituloCelda" >
...
NOMBRE:' . $NombreCompleto . '
                        ...
                        <td >
                            <label class="letraTitulo" colspan="6" >
