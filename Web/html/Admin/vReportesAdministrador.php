...
<head>
    ...
    <!--Funciones-->
    <script src="../../JavaScript/funcionesAdministrador.js"></script>
    <script src="../../JavaScript/funcionesGenerales.js"></script>
    <script src="../../JavaScript/funcionesCalendario.js"></script>    <script src="../Paginator/jquery/jquery-1.11.3.js"></script>
...
<div class="row" align="center">
    <table width="60%" class="border border-primary" align="center">
        ...
        <tr align="center">
            ...
            <td align="center">
                <img src="../../style/Img/excel.png" alt="Excel" onclick="exportar(1)">
                &nbsp;&nbsp;
                <img src="../../style/Img/pdf_xs.png" alt="PDF" onclick="exportar(2)">
            </td>
            <td align="center">
