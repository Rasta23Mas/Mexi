        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown" id="menuEmpeno">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <li><a class="dropdown-item" href="vRefrendo.php?tipoFormGet=1">Refrendo</a></li>
                    <li><a class="dropdown-item" href="vRefrendo.php?tipoFormGet=3">Desempeños</a></li>
            ...
            <li class="nav-item dropdown" id="menuEmpenoAuto">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <li><a class="dropdown-item" href="vRefrendo.php?tipoFormGet=2">Refrendo</a></li>
                    <li><a class="dropdown-item" href="vRefrendo.php?tipoFormGet=4">Desempeños</a></li>
                    <li><a class="dropdown-item" href="vConsultaContrato.php">Consulta</a></li>
                </ul>
            </li>
