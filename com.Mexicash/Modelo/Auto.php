...
class Auto
{
     ...
     * @return mixed
     */
    public function getIdTipoInteres()
    {
        return $this->idTipoInteres;
    }

    /**
     * @param mixed $idTipoInteres
     */
    public function setIdTipoInteres($idTipoInteres): void
    {
        $this->idTipoInteres = $idTipoInteres;
    }
