...
if($tipeFormulario==1||$tipeFormulario==2){
    $sqlDesempeno->generar($tipeFormulario,$descuento,$contrato,$token,$tipoContrato,$token_interes,$token_moratorio,
        $token_gps,$token_pension,$token_poliza,$token_movimiento,$token_decripcion);
}else if ($tipeFormulario==3||$tipeFormulario==4){
    $sqlDesempeno->generarDes($tipeFormulario,$descuento, $contrato, $idEstatusArt, $token,
